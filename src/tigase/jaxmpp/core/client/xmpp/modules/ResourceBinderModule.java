...
public class ResourceBinderModule implements XmppModule {
	...
	public void addListener(EventType eventType,
			Listener<ResourceBindEvent> listener) {
	...
	public void bind() throws XMLException, JaxmppException {
		...
		Element bind = new DefaultElement("bind", null,
				"urn:ietf:params:xml:ns:xmpp-bind");
		iq.addChild(bind);
		bind.addChild(new DefaultElement("resource", (String) sessionObject
				.getProperty(SessionObject.RESOURCE), null));
		...
		writer.write(iq, new AsyncCallback() {
			...
			public void onError(Stanza responseStanza, ErrorCondition error)
				...
				ResourceBindEvent event = new ResourceBindEvent(
						ResourceBindError, sessionObject);
			...
			public void onSuccess(Stanza responseStanza) throws JaxmppException {
				String name = null;
				Element bind = responseStanza.getChildrenNS("bind",
						"urn:ietf:params:xml:ns:xmpp-bind");
				if (bind != null) {
				...
				if (name != null) {
					...
					ResourceBindEvent event = new ResourceBindEvent(
							ResourceBindSuccess, sessionObject);
					event.setJid(jid);
