...
public class Room {
	...
	public Room(long id, PacketWriter writer, BareJID roomJid, String nickname,
	...
	public Presence rejoin() throws JaxmppException {
		this.nickname = sessionObject.getUserProperty(SessionObject.NICKNAME);
		Presence presence = Presence.create();
		presence.setTo(JID.jidInstance(roomJid, nickname));
		final DefaultElement x = new DefaultElement("x", null,
	...
	public void sendMessage(String body, String messageId) throws XMLException,
			JaxmppException {
		Message msg = Message.create();
		msg.setId(messageId);
		msg.setTo(JID.jidInstance(roomJid));
	...
	public void setLastMessageDate(Date date) {
		if (lastMessageDate == null || date == null
				|| lastMessageDate.getTime() < date.getTime()) {
	...
	public String toString() {
		return "Room{" + "id=" + id + ", nickname=" + nickname + ", roomJid="
				+ roomJid + '}';
	}
