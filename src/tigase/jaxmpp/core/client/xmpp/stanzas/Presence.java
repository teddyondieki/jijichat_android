...
public class Presence extends Stanza {
	...
	public Presence(Element element) throws XMLException {
		...
		if (!"presence".equals(element.getName()))
			throw new RuntimeException("Wrong element name: "
					+ element.getName());
	}
	...
	public String getNickname() throws XMLException {
		...
		cacheNickname = getChildElementValue("nick",
	...
	public void setNickname(String nickname) throws XMLException {
		setChildElementValue("nick", "http://jabber.org/protocol/nick",
	...
	public void add(Element presence, String name, String[] childNames,
